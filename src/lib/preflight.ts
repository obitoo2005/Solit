...
/**
 * Surface a preflight failure as a sonner toast.
 *
 * Pure rejection: shows the reason + hint, no action button. The user is
 * expected to top up their wallet themselves (via Phantom, the AccountChecker
 * banner, the dedicated /account airdrop modal, or wherever else) and try
 * the settle again. We do NOT auto-trigger faucets or airdrops from here.
 */
