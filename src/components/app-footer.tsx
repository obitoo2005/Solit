...
export function AppFooter() {
  return (
    <footer className="border-t border-foreground/10 bg-background/60 backdrop-blur-sm">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-y-2 px-6 py-4 text-xs font-mono-tight text-muted-foreground">
        ...
        <div className="flex items-center gap-3 sm:gap-4">
          <span>Built by Abdul Haseeb · Located in Faisalabad 🇵🇰</span>
